...
export default function SelectLotteryBtn() {
    ...
    <div className="relative inline-block text-left">
        <button
            ...
            type="button"
            className="inline-flex items-center justify-center rounded-md border border-gray-600 px-4 py-2 bg-gray-700 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none"
        >
