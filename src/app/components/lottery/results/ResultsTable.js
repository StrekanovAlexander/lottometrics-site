        ...
        <table className="inline-block bg-white rounded-lg shadow-sm border border-gray-200">
            <thead>
                <tr className="border-b border-gray-200 text-sm text-gray-700 text-left">
                    <th className="px-2 md:px-4 py-2 font-normal">Date</th>
                    <th className="px-2 md:px-4 py-2 font-normal">Main Numbers</th>
                    <th className="px-2 md:px-4 py-2 font-normal">Extra</th>
                </tr>
            </thead>
            <tbody>
                {data.map(el =>
                <tr className="border-b border-gray-100">
                    <td className="px-2 md:px-4 py-1 text-sm text-gray-600 font-semibold">
                    ...
                    <td className="px-2 md:px-4 py-1">
                        <div className="flex flex-nowrap gap-1 md:gap-2 text-gray-700">
